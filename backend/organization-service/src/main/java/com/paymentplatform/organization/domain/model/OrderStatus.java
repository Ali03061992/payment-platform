...
public enum OrderStatus {
    ...
    DRAFT, CONFIRMED, PREPARING, READY_FOR_DELIVERY, IN_DELIVERY, DELIVERED, ACCEPTED, CANCELLED, REJECTED, DELIVERY_REJECTED;
    ...
    static {
        ...
        TRANSITIONS.put(READY_FOR_DELIVERY, EnumSet.of(IN_DELIVERY));
