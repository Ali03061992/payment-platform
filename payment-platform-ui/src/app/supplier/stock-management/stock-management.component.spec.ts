// @ts-nocheck
/**
 * Tests du composant StockManagementComponent.
 * Perimetre : instanciation et blocs loadData, getStockStatus, getStockPercent, applyFilters, computeStats (voir blocs describe/it).
