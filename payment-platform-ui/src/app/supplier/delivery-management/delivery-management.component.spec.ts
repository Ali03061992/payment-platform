// @ts-nocheck
/**
 * Tests du composant DeliveryManagementComponent.
 * Perimetre : instanciation et blocs activeDeliveries, completedDeliveries, pendingAcceptance, rejectedDeliveries, acceptDelivery (voir blocs describe/it).
