// @ts-nocheck
/**
 * Tests du composant FamilyManagementComponent.
 * Perimetre : instanciation et blocs ngOnInit, supplierId, getCategoryNames, toggleCategory, isCategorySelected (voir blocs describe/it).
