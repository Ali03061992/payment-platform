// @ts-nocheck
/**
 * Tests du composant OrderManagementComponent.
 * Perimetre : instanciation et blocs ngOnInit, ngOnDestroy, filteredOrders, statusLabel, statusClass (voir blocs describe/it).
