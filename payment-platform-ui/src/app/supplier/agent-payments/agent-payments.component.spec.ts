// @ts-nocheck
/**
 * Tests du composant AgentPaymentsComponent.
 * Perimetre : instanciation et blocs computeTotals, toggleAgent, getAgentPayments, statusLabel, load (voir blocs describe/it).
