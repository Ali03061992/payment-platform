// @ts-nocheck
/**
 * Tests du composant StockOptimizationComponent.
 * Perimetre : instanciation et blocs loadOptimization, applyConfig, selectProduct, abcColor, abcBg (voir blocs describe/it).
