// @ts-nocheck
/**
 * Tests du composant AccountActivationComponent.
 * Perimetre : instanciation et blocs ngOnInit, loadUsers, filteredUsers, activate, disable (voir blocs describe/it).
