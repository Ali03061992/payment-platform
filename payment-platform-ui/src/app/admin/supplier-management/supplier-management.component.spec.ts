// @ts-nocheck
/**
 * Tests du composant SupplierManagementComponent.
 * Perimetre : cas should load suppliers on init; should handle load error; should create supplier with valid name (voir blocs describe/it).
