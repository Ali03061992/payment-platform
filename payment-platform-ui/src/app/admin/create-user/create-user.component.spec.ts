// @ts-nocheck
/**
 * Tests du composant CreateUserComponent.
 * Perimetre : instanciation et blocs ngOnInit, requiresOrganization, organizationLabel, availableOrgs, onSubmit (voir blocs describe/it).
