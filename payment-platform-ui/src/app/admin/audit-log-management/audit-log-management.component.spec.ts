// @ts-nocheck
/**
 * Tests du composant AuditLogManagementComponent.
 * Perimetre : cas should load logs on init; should handle load error; should apply filter and reset to first page (voir blocs describe/it).
