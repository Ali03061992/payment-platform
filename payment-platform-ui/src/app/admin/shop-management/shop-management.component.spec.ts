// @ts-nocheck
/**
 * Tests du composant ShopManagementComponent.
 * Perimetre : cas should load shops on init; should handle load error; should create shop with valid name (voir blocs describe/it).
