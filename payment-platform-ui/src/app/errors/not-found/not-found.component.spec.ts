// @ts-nocheck
/**
 * Tests du composant NotFoundComponent.
 * Perimetre : cas should display 404 content; should go to dashboard when logged in; should go to login when anonymous (voir blocs describe/it).
