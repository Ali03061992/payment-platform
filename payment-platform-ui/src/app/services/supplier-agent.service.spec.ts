// @ts-nocheck
/**
 * Tests du service SupplierAgentService.
 * Perimetre : instanciation et blocs listAgents, createAgent, updateAgent, activateAgent, disableAgent (voir blocs describe/it).
